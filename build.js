...
const CORE = ['expr', 'rng', 'store', 'time', 'fight', 'validate', 'assets', 'party', 'calendar', 'scenario', 'board', 'messenger', 'shop', 'quest', 'choice', 'patch', 'engine', 'render', 'session', 'diagnose', 'editor', 'templates'];
