...
const CORE = ['expr', 'rng', 'store', 'time', 'fight', 'validate', 'assets', 'party', 'calendar', 'scenario', 'board', 'messenger', 'shop', 'quest', 'choice', 'secret', 'checkpoint', 'front', 'patch', 'engine', 'render', 'session', 'diagnose', 'editor', 'templates'];
